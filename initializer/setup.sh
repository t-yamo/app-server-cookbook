...
echo "(03. # knife configure)"
echo "04. clone cookbooks from git."
echo "05. copy /home/${DEV_USER}/.ssh/id_rsa to <chef>/site-cookbooks/initial_users/files/default/devuser/id_rsa"
echo "06. copy /home/${DEV_USER}/.ssh/id_rsa.pub to <chef>/site-cookbooks/initial_users/files/default/devuser/id_rsa.pub"
echo "07. cd git project (cloned cookbooks)."
